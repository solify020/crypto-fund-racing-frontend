          ...
          <div className="flex-1">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-primary-gray-light mb-3">
                  ...
                  {campaign.socialLink && (
                    <a
                      ...
                      className="text-accent-red hover:text-accent-red-dark transition-colors"
                    >
                      🌐 Social Link
                    </a>
                  )}
            ...
            <p className="text-primary-gray-light leading-relaxed mb-4 line-clamp-2">{campaign.description}</p>

            {/* Progress bar */}
            <div className="mb-4">
              <div className="w-full h-3 bg-primary-gray rounded-full overflow-hidden mb-2">
                <div
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="font-bold text-white">{campaign.currentAmount} ETH</span>
                <span className="text-primary-gray-light">of {campaign.targetAmount} ETH</span>
                <span className="font-semibold text-accent-red">{progress.toFixed(1)}% funded</span>
              </div>
            </div>
